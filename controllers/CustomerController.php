 ...
 */
class Cammino_Couponlist_CustomerController extends Mage_Adminhtml_Controller_Action
{
    /**
    ...
    public function couponListAction()
    {
        ...
        $this->getLayout()->createBlock('couponlist/adminhtml_customer_edit_tab_couponlist','admin.customer.coupon')->setCustomerId(Mage::registry('current_customer')->getId())
            ->setUseAjax(true)
            ->toHtml()
        );
    }
